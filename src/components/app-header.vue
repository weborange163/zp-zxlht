...
<m-navbar :theme="theme.theme.headerTheme">
  ...
  <m-nav align="right">
    <m-nav-item padding="0">
      <i class="iconfont icon-user" style="font-size: 20px;vertical-align: middle;"></i>&nbsp;<span v-if="user">{{user.username}}</span>
    </m-nav-item>
    <m-nav-item padding="0">
      <i class="iconfont icon-user" style="font-size: 20px;vertical-align: middle;"></i>&nbsp;<span>修改密码</span>
    </m-nav-item>
     <m-nav-item padding="0">
      <i class="iconfont icon-user" style="font-size: 20px;vertical-align: middle;"></i>&nbsp;<span>退出</span>
    </m-nav-item>
    <!-- <m-nav-item padding="0">
